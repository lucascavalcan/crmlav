...
class AppStateNotifier extends ChangeNotifier {
  OnboardingCRMFirebaseUser? initialUser;
  OnboardingCRMFirebaseUser? user;
  ...
  void update(OnboardingCRMFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'Agenda',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Main_agenda')
                  : MainAgendaWidget(),
            ),
            FFRoute(
              name: 'Main_Contracts',
            ...
            FFRoute(
              name: 'Main_LojasFinalizadas',
              path: 'LojasDois',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Main_LojasFinalizadas')
                  : MainLojasFinalizadasWidget(),
            ),
            FFRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/liquid-preloader_dribbble_v2.gif',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
