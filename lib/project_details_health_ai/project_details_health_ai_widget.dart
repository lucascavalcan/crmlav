                                ...
                                child: Card(
                                  ...
                                  child: Padding(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(12),
                                      child: Image.asset(
                                        'assets/images/LOGO_MOLDURA_AZUL.png',
                                        width: 60,
                                        height: 60,
                                        fit: BoxFit.contain,
                                      ),
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'mxf4vrjw' /* Lavanderia 60 Minutos. */,
                                    ),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'wsgonkz2' /* Contratos para Novas Oportunid... */,
                                      ),
