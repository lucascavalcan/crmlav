                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              if (Theme.of(context).brightness ==
                                  Brightness.light)
                                Image.asset(
                                  'assets/images/logos_horizontal-01_light.png',
                                  width: 150,
                                  height: 50,
                                  fit: BoxFit.fitWidth,
                                ),
                              if (Theme.of(context).brightness ==
                                  Brightness.dark)
                                Image.asset(
                                  'assets/images/logos_horizontal-02_dark.png',
                                  width: 150,
                                  height: 50,
                                  fit: BoxFit.fitWidth,
                                ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'hywgg8eu' /* Um novo contrato foi gerado pa... */,
                            ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '60n0fqw5' /* Enviaremos um e-mail com detal... */,
                            ),
                            style: FlutterFlowTheme.of(context).bodyText2,
                          ).animateOnPageLoad(
